...
export default function Hero() {
  ...
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="w-full min-h-[90vh] px-6 py-6 lg:py-1 relative ">
        <div className="relative w-full h-[420px] lg:h-[480px] flex items-center justify-center">
          
          {/* LEFT CONTENT */}
          <div className="max-w-xl  hero-content">
            <div className="inline-block   border-2  border-black px-3 py-1 rounded-full font-bold mb-4 text-sm -rotate-2 brutalist-shadow">
